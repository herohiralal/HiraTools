...
{
    public abstract class SerializableBlackboardValueDrawerBase : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            // calculation type
            {
                ...
                var (displayNames, reflectionNames) = BuildCalculationData(keyProperty.objectReferenceValue);
        ...
        private (string[], string[]) BuildCalculationData(Object key)
        {
            if (!(key is SerializableBlackboardKey sKey)) return (null, null);
            return BuildCalculationData(sKey);
        }
        protected abstract (string[], string[]) BuildCalculationData(SerializableBlackboardKey key);
