...
namespace UnityEngine
{
    ...
    public class HiraBlackboardKeySet : HiraCollection<SerializableBlackboardKey>, IBlackboardKeyData
    {
        ...
        public void Initialize() => _mainKeyData = BlackboardTypes.GetKeyData(collection1 as SerializableBlackboardKey[]);
        ...
        public SerializableBlackboardKey[] Keys => collection1 as SerializableBlackboardKey[];
    }
}